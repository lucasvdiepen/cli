...
class RunnerImageTag {
  ...
  constructor(options: YargsArguments) {
    ...
    const effectivePlatform = RunnerImageTag.toNodePlatform(hostOS, hostPlatform);
    ...
    this.imagePlatformPrefix = RunnerImageTag.getImagePlatformPrefixes(effectivePlatform);
